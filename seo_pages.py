    ...
    for prof_slug, prof in PROFESSIONS.items():
        ...
        pages[slug] = {
            ...
            "faqs": [
                ...
                {"q": "How much does it cost?", "a": "BankScan AI offers a free tier so you can try it with no commitment. Paid plans start from $9.99/month for higher volumes. No long-term contracts."},
        ...
        for prof_slug, prof in combo_professions.items():
            ...
            pages[slug] = {
                ...
                "faqs": [
                    ...
                    {"q": "Is there a free option?", "a": "Yes. BankScan AI offers a free tier so you can try the converter with no commitment. Paid plans from $9.99/month unlock batch conversion and higher volumes."},
                ],
        ...
        for sw_slug, sw in ACCOUNTING_SOFTWARE.items():
            ...
            pages[slug] = {
                ...
                "faqs": [
                    ...
                    {"q": "Is there a free option?", "a": "Yes. BankScan AI offers a free tier to try the converter. Paid plans from $9.99/month for higher volumes."},
                ],
        ...
        for uc_slug, uc in USE_CASES.items():
            ...
            pages[slug] = {
                ...
                "faqs": [
                    ...
                    {"q": "Is there a free option?", "a": "Yes. Try BankScan AI free with limited conversions. Paid plans from $9.99/month."},
                ],
                "cta_text": f"Convert for {uc['name']} — Free",
            }
    return pages
